...
export const ACCEPTANCE_CRITERIA: AcceptanceCriterion[] = [
  {
    ...
    stateId: 't0',
    situation: 'Three accounts, one family, nothing corroborated. Integrity 23.',
  ...
  },
  {
    ...
    stateId: 't1',
    subject: 'cl-domingo',
    situation: 'An account nobody has rendered into English. Weight 0, no text, no elements.',
  ...
  },
  {
    ...
    stateId: 't2',
    subject: 'cl-domingo',
    situation: 'The unrendered account from t1 now has a rendering. The original is unchanged.',
  ...
  },
  {
    ...
    situation: 'A new account suggests two competing readings were both true. The disputes still stand.',
